...
If you are using the Managed LLM feature on [Defang Playground](/docs/concepts.defang-playground), please note that your `MODEL` (model ID) will be limited to `us.amazon.nova-micro-v1:0`.
