...
In the example above, if we assume the value of the configuration variable _**USER_PASSWORD**_ is _password_ then the value assigned to _**CONNECT**_ will resolve to _dbservice:alice:password@example.com:9876_
