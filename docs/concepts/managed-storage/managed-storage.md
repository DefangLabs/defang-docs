...
:::info[Availability]
Managed storage services are available on all tiers (Starter, Pro, Enterprise) when deploying via BYOC. Defang Playground does not support managed storage services.
:::
