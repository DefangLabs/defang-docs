...
:::warning
The Defang Pulumi Provider is not currently available. See [Pulumi](./pulumi.md).
:::
```typescript
...
```
  ...
  <TabItem value="pulumi" label="Pulumi">
:::warning
The Defang Pulumi Provider is not currently available, so you cannot bring your own domain through it. See [Pulumi](./pulumi.md).
:::
  </TabItem>
</Tabs>
