...
:::warning
The Defang Pulumi Provider is not currently available. The Defang-hosted environment it deployed to has been discontinued, and it does not yet support deploying to your own cloud account. This tutorial is kept for reference. To deploy today, use a [Compose file](../concepts/compose.md).
:::
...
Defang gives your service a domain, which you can obtain by running the following command:
