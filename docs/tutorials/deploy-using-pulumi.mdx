...
:::warning
At the time of writing, the Defang Pulumi Provider does not yet support [BYOC](../concepts/defang-byoc.md). We are working on adding support.
:::
...
Defang will give you a domain, which you can obtain by running the following command:
