...
You can provide the credentials you set up [earlier](#e-save-your-access-keys) or use another preferred credential set. Choose a default [region](https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-regions.html#available-regions) where you’d like to host the application. The output format can be left as the default by pressing `Enter`, or you can specify a different format if you prefer.
