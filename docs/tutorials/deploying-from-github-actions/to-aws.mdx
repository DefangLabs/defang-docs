...
<Tabs>
  <TabItem value="cli" label="AWS CLI" default>
    ```bash aws sts get-caller-identity --query Account --output text
    123456789012 # for example ```
  </TabItem>
  <TabItem value="dashboard" label="AWS Dashboard">
    1. Go to the [AWS Management Console](https://aws.amazon.com/console/). 2.
    In the top right corner, click on your account name or number. 3. Your AWS
    Account ID will be displayed in the dropdown menu.
  </TabItem>
</Tabs>
