...
<Tabs>
  <TabItem value="cli" label="Azure CLI" default>
    You can list all of the subscriptions you have access to with the following
    command: ```bash az account list --output table export
    SUBSCRIPTION_ID="your-subscription-id" # export the subscription ID you want
    to use ```
  </TabItem>
  <TabItem value="dashboard" label="Azure Portal">
    1. Go to the [Azure Portal](https://portal.azure.com/). 2. Navigate to
    **Subscriptions**. 3. Identify the appropriate subscription from the list.
