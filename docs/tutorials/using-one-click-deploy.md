...
description: Use 1-Click Deploy to easily deploy a sample with Defang.
---
...
The 1-Click Deploy button is the easiest way for new users to deploy a sample project with Defang. No CLI installation is required.
...
A Github Action workflow will automatically start running to install Defang and deploy the sample. You can see this by going into the "Actions" tab in your GitHub repository.
...
:::tip
If you decide to make a commit later to a repository created from 1-Click Deploy, then the project will automatically get deployed again.
:::
