...
- While we currently support [AWS](/docs/providers/aws) for production, [GCP](/docs/providers/gcp) and [DigitalOcean](/docs/providers/digitalocean) are in preview with [Defang V1](https://defang.io/blog/-defang-v1-launch-week-is-here). We plan to support other clouds, such as [Azure](/docs/providers/azure), in future releases.
