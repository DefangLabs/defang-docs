...
description: Get started with Defang Deploy.
---
...
Defang Deploy doesn't require installing anything in your cloud, but you will need to install the [open source](https://github.com/DefangLabs/defang) Defang command line interface (CLI) to interact with your Defang resources and account.
...
Defang deploys to your own cloud account, so you need an account with one of the supported providers: AWS, GCP, Azure, or DigitalOcean. Each provider page lists the credentials Defang expects and how to set them up. See [Defang Providers](/docs/providers).

Set up your cloud credentials the way you normally would for that provider, for example `aws configure` or `gcloud auth application-default login`.

### Deploy

Go back to your shell and deploy to the provider you picked:

```
$ defang compose up --provider=aws
```

Use `--provider=gcp`, `--provider=azure`, or `--provider=digitalocean` to deploy to the other providers.
 ...
 * Monitor your services' status in the defang portal
   - https://portal.defang.io/service/app
 ...
 * Service app is in state DEPLOYMENT_COMPLETED and will be available at:
   - https://app--3000.welcome-to-defang.<tenant-id>.defang.app
 * Done.
```

Now go to [https://portal.defang.io/service/app](https://portal.defang.io/service/app) to see your service listed in the Defang portal.

![screenshot of the defang portal](/img/getting-started-portal.png)

## Next Steps

Congratulations! You've successfully deployed your first service with Defang Deploy. Now, where do you go from here?

Defang Deploy supports various ways of creating and deploying services to the cloud. The following tutorials dive into each one in more detail:
...
<DocCardList
  items={[
    ...
    },
    {
        ...
        description: "Use Defang Deploy to generate and deploy a new project",
    },
    {
        type: "link",
        href: "/docs/cli",
    ...
    },
    {
        ...
        description: "Learn how to monitor your services with Defang Deploy",
    }
  ]}
/>
